...
$connectstr_dbhost = getenv('20.190.114.104');
$connectstr_dbname = getenv('kwad_db');
$connectstr_dbusername = getenv('root');
$connectstr_dbpassword = getenv('TA13KWAD!');

/** The name of the database for WordPress */
define('DB_NAME','kwad_db');

/** MySQL database username */
define('DB_USER','root');

/** MySQL database password */
define('DB_PASSWORD','TA13KWAD!');

/** MySQL hostname */
define('DB_HOST','20.190.114.104');
